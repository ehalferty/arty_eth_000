...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir C:/Users/phaz/vivado_projects/arty_eth_000/arty_eth_000.runs/arty_eth_000_clk_wiz_0_1_synth_1 -new_name arty_eth_000_clk_wiz_0_1 -ip [get_ips arty_eth_000_clk_wiz_0_1]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top arty_eth_000_clk_wiz_0_1 -part xc7a35ticsg324-1L -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix arty_eth_000_clk_wiz_0_1_ arty_eth_000_clk_wiz_0_1.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ arty_eth_000_clk_wiz_0_1_stub.v
 lappend ipCachedFiles arty_eth_000_clk_wiz_0_1_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ arty_eth_000_clk_wiz_0_1_stub.vhdl
 lappend ipCachedFiles arty_eth_000_clk_wiz_0_1_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ arty_eth_000_clk_wiz_0_1_sim_netlist.v
 lappend ipCachedFiles arty_eth_000_clk_wiz_0_1_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ arty_eth_000_clk_wiz_0_1_sim_netlist.vhdl
 lappend ipCachedFiles arty_eth_000_clk_wiz_0_1_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp arty_eth_000_clk_wiz_0_1.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips arty_eth_000_clk_wiz_0_1]
}

rename_ref -prefix_all arty_eth_000_clk_wiz_0_1_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef arty_eth_000_clk_wiz_0_1.dcp
